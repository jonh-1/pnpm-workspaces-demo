...
import { getRandomNumber } from '@livekit-pnpm-workspace/internal';
...
/** Workspace-internal value (from `@livekit-pnpm-workspace/internal`) used at agent startup. */
const INTERNAL_RANDOM = getRandomNumber();
...
export default defineAgent<ProcessUserData>({
  ...
  entry: async (ctx) => {
    console.info('[agent] internal random from workspace:', INTERNAL_RANDOM);
